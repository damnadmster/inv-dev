...
class FilialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filial" do
    assert_difference('Filial.count') do
      post filials_url, params: { filial: { code: @filial.code, name: @filial.name, num: @filial.num } }
    end
  ...
  test "should update filial" do
    patch filial_url(@filial), params: { filial: { code: @filial.code, name: @filial.name, num: @filial.num } }
