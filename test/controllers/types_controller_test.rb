...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { filial_id: @type.filial_id, name: @type.name, num: @type.num } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { filial_id: @type.filial_id, name: @type.name, num: @type.num } }
